...
namespace API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        /*
                [HttpGet]
                public ActionResult <IEnumerable<AppUser>> GetUsers() // https://localhost:5001/api/users
                {
                ...
                [HttpGet("{id}")]
                public  ActionResult<AppUser> GetUser(int id)   // https://localhost:5001/api/users/1
                {
